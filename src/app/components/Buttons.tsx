...
interface IconButtonProps extends React.PropsWithChildren, React.HTMLAttributes<HTMLButtonElement> {
...
export const IconButton: React.FC<IconButtonProps> = (props) => {
    ...
    return (
        <button className={"flex gap-2 bg-highlight rounded-lg border-2 border-black px-4 py-2 font-medium hover:scale-105 transition-all hover:bg-black hover:text-white hover:fill-white " + props.className} {...props}>
            <Icon.type />
            {props.children}
        </button>
    )
