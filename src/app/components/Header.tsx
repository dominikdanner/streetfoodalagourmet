...
const SmarthphoneNavigationMenu = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div className="flex flex-col gap-1.5 scale-110 justify-center items-center transition-all w-fit h-full cursor-pointer z-50" onClick={() => setNavigationMenuExpanded(!isNavigationMenuExpanded)}>
            ...
            {isNavigationMenuExpanded ? (
                ...
                <div className="fixed transition-all right-0 top-20 bg-white w-full h-full animate-fade-in">
                    ...
                    <div className="flex flex-col justify-center items-center gap-10 mt-20">
                        ...
                        <SmarthphoneHeaderMenuItem href={"/"} alternative={[]} name={"Home"} />
                        <SmarthphoneHeaderMenuItem href={"/team"} alternative={[]} name={"Team"} />
                        <SmarthphoneHeaderMenuItem href={"/galerie"} alternative={["/galerie/album"]} name={"Galerie"} />
                        <SmarthphoneHeaderMenuItem href={"/contact"} alternative={[]} name={"Kontakt"} />
            ...
            <div className="fixed w-full z-50">
                ...
                <header className={scrollOffset.y! < 1 ? "flex justify-between mx-40 items-center h-28 transition-all" : "flex justify-between px-40 items-center h-32 shadow-sm  bg-white transition-all duration-200 ease-in-out"}>
                    ...
                    <div className="flex gap-10">
                        ...
                        <DesktopHeaderMenuItem href={"/team"} alternative={[]} name="Team" />
                        <DesktopHeaderMenuItem href={"/galerie"} alternative={["/galerie/album"]} name="Galerie" />
                        <DesktopHeaderMenuItem href={"/contact"} alternative={[]} name="Kontakt" />
                    </div>
...
const SmarthphoneHeaderMenuItem: React.FC<HeaderMenuItemProps> = (props) => {
    return (
        <div className="cursor-pointer font-semibold text-black text-2xl">
            ...
            {typeof window !== "undefined" && (document.location.pathname == props.href || props.alternative.some(route => document.location.pathname == route)) ? <div className="w-1/2 h-1 rounded-lg opacity-75 bg-black"></div> : null}
