...
export default function TeamOverviewLayout({
  ...
  return (
        ...
        <div className="relative overflow-hidden flex flex-col items-center w-full">
            ...
            <Image src={GarlicSVG} alt="Garlic" className="absolute right-[100px] top-[1340px] -rotate-45 scale-125"></Image>
            <Image src={Kraut2SVG} alt="Garlic" className="absolute scale-100 top-[750px] left-[500px] -z-50"></Image>
            <Image src={PanSVG} alt="Pan" className="absolute scale-125 bottom-[10px] left-[100px] lg:bottom-[200px] lg:left-[100px] -z-50"></Image>
